...
class RegistroTiempo:
    ...
    def crear(self):
        ...
        cur.execute(f'INSERT INTO registro_tiempo (id_empleado, id_proyecto, fecha, hora, descripcion FROM registro_tiempo) \
    ...
    def listar(self):
        ...
        cur.execute('SELECT id, id_empleado, id_proyecto, fecha, horas, descripcion FROM registro_tiempo')
    ...
    def buscar(self):
        ...
        cur.execute(f'SELECT id, id_empleado, id_proyecto, fecha, horas, descripcion FROM registro_tiempo WHERE id = "{id_registro}"')
    ...
    def editar(self):
        ...
        cur.execute(f'UPDATE registro_tiempo SET horas="{horas}", descripcion="{descripcion}" WHERE id="{id_registro}"')
        mydb.commit()
    ...
    def eliminar(self):
        ...
        cur.execute(f'DELETE FROM registro_tiempo where id="{id_registro}"')
